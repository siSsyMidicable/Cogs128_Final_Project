    ...
    <SafeAreaView style={s.safe}>
      ...
      <View style={s.header}>
        ...
        <Pressable
          ...
          accessibilityRole="button"
        >
          <HistoryIcon size={16} color="#61d8cc" />
          <Text style={s.historyBtnLabel}>Swap History</Text>
        </Pressable>
      </View>
...
const s = StyleSheet.create({
  ...
  historyBtn:      { flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: 12, paddingVertical: 10, borderRadius: 8, borderWidth: 1, borderColor: '#243836' },
  historyBtnLabel: { fontSize: 13, fontWeight: '700', color: '#61d8cc' },
